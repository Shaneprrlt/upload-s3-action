...
const S3 = __nccwpck_require__(527);
const fs = __nccwpck_require__(147);
const path = __nccwpck_require__(17);
const shortid = __nccwpck_require__(188);
const slash = (__nccwpck_require__(263)["default"]);
const klawSync = __nccwpck_require__(709);
const { lookup } = __nccwpck_require__(806);
